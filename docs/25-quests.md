...
| **Episode quests** | The 6-episode main story. Episode 0 begins in Blooming Cora (deliver the Registration Form to Bunny Maid); Episode 1 "Nefertiti's Necklace" starts at Gate of Caballa Relics (Monkey T, Lv 45+) and chains through Old Artist, Guide Sabrina, and more; later episodes span every region up to Episode 6. Chapter-based with large EXP rewards (~257k base / 121k TM per step at Episode 1). |
   ...
   **The full episode-start registry (client `SystemHelp` OpenValue triggers):** Episode 1 **Lv 45** at the Relics gate (Tiphmont Ktangkong); Episode 2 **Lv 80** at the Mermaid Palace dungeon entrance (**Seawitch Karihara**); Episode 3 **Lv 130** at the Alteo construction site (**Supervisor Amos**); Episode 4 **Lv 150** at the Underground Dev Room's underground passage (**Cowardly Guard Craven**); Episode 5 **Lv 160** at the Dev Room's **First-Class Control Room — the "Memory Regeneration System" itself** as quest-giver; and Episode 6 **Lv 200** — from **Don Cavalier himself, inside the Sarcophagus Space (석관 속 공간)**: the dead chairman hands out his own finale. The **key-quest level ladder** runs in parallel: Desert Beach 25 → Relics 55 → Oops Wharf 70 → Mermaid 80 → Ghost Blue 100 → Rose Garden 125 → Black Swamp 150 → Snow Hill 170 → Techichi 210 → Tapasco 235.
