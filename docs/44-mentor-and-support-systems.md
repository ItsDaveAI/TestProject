...
- **Graduation:** when the beginner stops being a beginner, the list and mark disappear ("졸업 축하합니다!") and the angel receives a **wing mark for one week** as thanks ("저 졸업했어요!!"). The milestone mail sends a **Graduation Ring (졸업반지) at Lv 31** (`PostBoxLevelUpGiftInfo`, see [Stats](02-stats-and-base-leveling.md)) — the graduation memento arriving by postbox — while the Notice system's angel-eligibility warning fires at Lv 50; the two thresholds mark the same beginner→veteran transition at different service moments.
