...
**Ghost growth-stones (client `GhostExchange_Group`, 36 groups):** a late-era exchange layer organizes the compound **growth-stone (성장조합석) equipment by level bracket** — e.g. group 20 binds the **Lv 290 stone family** (12 item IDs) for ghost-equipment exchange, gated by refine level (`GhostExchange_RefineLevel`) — the Ghost-equipment upgrade economy's grouping table.
