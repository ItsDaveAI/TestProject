...
**Prizes and the post-run economy (community wikis):** the **top killer** earns the **Harkon's Blessing** 3-hour fortune — 1st place: **AP +528, AC/MA/DA/LK +33, DX −11, MD/DP +528, HV +33** (2nd place +384-tier, 3rd +240-tier, all survivors +168-tier; PandaTO notes a bug zeroing the buff). The finale's **Chronos is a lesser copy of True Kronos** — the only source of **Chronos shards**, and the boss-class monsters each drop their own shards (Hecate of Magic, Charybdis of Sense, Gorgon of Power, Scylla of Charm), which **Stella** in Megalopolis Shop (under Mind's Eye) exchanges for **Altiverse equipment** — the shadow-gear ladder's endpoint. Shadow equipment itself sells to NPCs for ~60k apiece (PandaTO). Once entered, the Sanctuary cannot be left until it ends. Revival servers nickname the three attack patterns **Gloom / Normal / Boss** by difficulty (CoraTO).
...
- [Harkon Defense TLDR — CoraTO Wiki](https://mewsie.world/CoraTOWiki/index.php/Harkon_Defense_TLDR) (Gloom/Normal/Boss, Chronos shards, Stella exchange)
- [Harkon Protector — PandaTO Wiki](https://pandato.fandom.com/wiki/Harkon_Protector) (Harkon's Blessing ladder, 60k shadow equips, sanctuary lock)
