...
**Two regional story voices (client dialogs):** in **Oops Wharf's dungeon**, **Dr. Ray (레이)**, a physics PhD, is a **ghost** researching the separation of body and energy ("자네가 믿을지 모르겠지만, 난 인간의 육체와 에너지가 분리된… 흔히 말하는 귀신일세" — "hard to believe, but I am a soul separated from body and energy… what people call a ghost") whose abandoned **research journal** would "endanger countless lives" if left behind. In **Vamp Castle**, the dungeon's route is a **carpet-color choice**: two NPC doors — "라이칸님에게 설명은 들었지? 날 선택했다는 것은 빨간색 카펫이 깔린 복도로 가겠다는 말이지?" ("Lycan explained it? Choosing me means taking the **red-carpet corridor**") — with the blue-carpet twin beside it, each hoping "the door at its end leads to our master's room": the castle maze as a branching red/blue choice.
